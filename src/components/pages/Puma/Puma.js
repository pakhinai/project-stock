      ...
      <div>
        ...
        >
          ...
          <DialogActions>
            ...
            <Button
              onClick={() => {
                dispatch(pumaAction.RemovePuma(selectId));
                handleClose();
                setTimeout(() => {
  ...
  const actions = [
    {
      ...
      onClick: (event, rowData) => {
        props.history.push(`/puma-edit/${rowData.id}`);
      },
    },
    {
      icon: () => <DeleteOutline />,
  ...
  return (
    <div style={{ width: "100%", height: "100vh", marginTop: 63 }}>
      <MaterialTable
        ...
        columns={columns}
        title="Puma"
        data={pumaReducer.pumaResult ? pumaReducer.pumaResult : []}
        components={{
          Toolbar: (props) => (
            <div>
              <MTableToolbar {...props} />
