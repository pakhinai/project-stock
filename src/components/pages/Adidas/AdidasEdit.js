...
export default function AdidasEdit(props) {
  ...
  useEffect(() => {   
      dispatch(adidasAction.getAdidasById(id))
  }, [])
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(adidasAction.EditAdidas(formData, props.match.params.id, props.history));
    },
  });
  ...
  return (
    <div
      style={{
        width: "100%",
        height: "100vh",
        backgroundImage: `url('/images/background-adidas.jpg')`,
        ...
        <Card className={classes.root}>
          <CardContent>
            <Typography gutterBottom variant="h5" component="div">
              Edit Adidas {props.match.params.id}
            </Typography>
            <form onSubmit={formik.handleSubmit}>
              ...
              <Button fullWidth variant="text" component={Link} to="/adidas">
                Cancel
              </Button>
            </form>
          </CardContent>
