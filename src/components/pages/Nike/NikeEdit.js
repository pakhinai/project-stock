...
export default function NikeEdit(props) {
  ...
  useEffect(() => {   
      dispatch(nikeAction.getNikeById(id))
  }, [])
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(nikeAction.EditNike(formData, props.match.params.id, props.history));
    },
  });
  ...
  return (
    <div
      style={{
        width: "100%",
        height: "100vh",
        backgroundImage: `url('/images/background-nike.jpg')`,
        ...
        <Card className={classes.root}>
          <CardContent>
            <Typography gutterBottom variant="h5" component="div">
              Edit Nike {props.match.params.id}
            </Typography>
            <form onSubmit={formik.handleSubmit}>
              ...
              <Button fullWidth variant="text" component={Link} to="/nike">
                Cancel
              </Button>
            </form>
          </CardContent>
